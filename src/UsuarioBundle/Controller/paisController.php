...
use UsuarioBundle\Entity\pais;
use UsuarioBundle\Form\paisType;
...
class paisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UsuarioBundle:pais')->findAll();

        return $this->render('UsuarioBundle:pais:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UsuarioBundle:pais:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UsuarioBundle:pais')->find($id);
        ...
        return $this->render('UsuarioBundle:pais:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UsuarioBundle:pais:edit.html.twig', array(
            'entity'      => $entity,
